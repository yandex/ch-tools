Feature: chadmin zookeeper commands.
  ...
  Scenario: Sync uuid for ReplicatedMergeTree
    ...
    When we execute query on clickhouse01
    """
    CREATE TABLE non_repl_db.test_table_2
    (
        `a` Int
    )
    ENGINE = ReplicatedMergeTree('/clickhouse/foo/shard1/test_table_2', '{replica}')
    ORDER BY a
    """
    ...
    ENGINE = ReplicatedMergeTree('/clickhouse/foo/shard2/test_table_1', '{replica}')
    ORDER BY a
    """
     When we execute query on clickhouse02
    """
    ...
    ENGINE = ReplicatedMergeTree('/clickhouse/foo/shard2/test_table_2', '{replica}')
    ORDER BY a
    """
    When we execute command on clickhouse01
    """
    chadmin zookeeper update '/clickhouse/foo/shard1/test_table_1/table_shared_id' 'a7434a27-e2e5-41d1-be33-6a1e19b33ab4'
    """
    Then it completes successfully
    When we execute command on clickhouse01
    """
    chadmin zookeeper update '/clickhouse/foo/shard1/test_table_2/table_shared_id' 'a7434a27-e2e5-41d1-be33-6a1e19b33ab3'
    """
    Then it completes successfully
    When we execute command on clickhouse01
    """
    ...
    """
    chadmin zookeeper get '/clickhouse/foo/shard1/test_table_1/table_shared_id'
    """
    Then we get response
    """
    a7434a27-e2e5-41d1-be33-6a1e19b33ab4
    """
    When we execute command on clickhouse02
    """
    chadmin zookeeper get '/clickhouse/foo/shard1/test_table_2/table_shared_id'
    """
    Then we get response
    """
