...
.PHONY: create-venv
create-venv: venv/bin/pip ;

venv/bin/pip:
	@echo 'Creating virtual environment'

	pyenv exec pip install -U virtualenv
...
freeze-requirements: requirements.txt requirements-dev.txt

.PHONY: requirements.txt requirements-dev.txt
requirements.txt requirements-dev.txt: venv/bin/pip
	@echo '# Generated by `make freeze-requirements`\n' > $@
	venv/bin/pip freeze -r $@.in --local | sed '/The following requirements were added by pip freeze/,$$ d' >> $@
