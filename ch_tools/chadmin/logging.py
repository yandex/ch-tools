...
def critical(msg, *args, **kwargs):
    ...
    getLogger("chadmin").opt(exception=with_exception).critical(msg, *args, **kwargs)
...
def error(msg, *args, **kwargs):
    ...
    """
    with_exception = kwargs.get("exc_info", False)
    getLogger("chadmin").opt(exception=with_exception).error(msg, *args, **kwargs)
...
def exception(msg, *args, **kwargs):
    ...
    with_exception = kwargs.get("exc_info", False)
    getLogger("chadmin").opt(exception=with_exception).debug(msg, *args, **kwargs)
...
def warning(msg, *args, **kwargs):
    ...
    """
    with_exception = kwargs.get("exc_info", False)
    getLogger("chadmin").opt(exception=with_exception).warning(msg, *args, **kwargs)
...
def info(msg, *args, **kwargs):
    ...
    """
    with_exception = kwargs.get("exc_info", False)
    getLogger("chadmin").opt(exception=with_exception).info(msg, *args, **kwargs)
