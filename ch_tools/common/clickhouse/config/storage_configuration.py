...
class ClickhouseStorageConfiguration:
    ...
    def s3_disk_configuaration(self, name: str, bucket_name_prefix: str) -> S3DiskConfiguration:
        ...
        _host, bucket_name, prefix, endpoint_url = _parse_endpoint(endpoint, bucket_name_prefix)
