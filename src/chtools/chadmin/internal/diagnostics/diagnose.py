...
from chtools.common.clickhouse.config import ClickhouseConfig, ClickhouseKeeperConfig, ClickhouseUsersConfig
...
def diagnose(ctx, output_format: str, normalize_queries: bool):
    ...
    if keeper_config.separated:
        tasks.append(diagnostics.add_xml_document('ClickHouse Keeper configuration', keeper_config.dump_xml()))
